 ...
 */
public class SwipeDismissListViewTouchListener implements
	...
	public interface DismissCallbacks {
		 ...
		 */
		void onDismiss(ListView recyclerView, int[] reverseSortedPositions);
	}

	/**
	 * Instantiates a new swipe dismiss recycler view touch listener.
	 *
	 * @param listView the recycler view
	 ...
	 */
	public ListView.OnScrollListener makeScrollListener() {
